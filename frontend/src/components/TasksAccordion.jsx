  ...
  return (
    <>
      <h2 id={`accordion-heading-${index}`}>
        <button
          type="button"
          className={`flex items-center w-full p-5 font-medium text-gray-500 border ${
      ...
      >
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-[#1D1D1D] max-h-[calc(100vh-10rem)] overflow-y-auto">
          {children}
        </div>
      </div>
    </>
...
const TasksAccordion = ({ items, defaultOpen = 0, allowMultiple = false }) => {
  ...
  return (
    <div
      className="left-0 w-full h-[100vh] overflow-y-auto"
