...
const TableConfig = ({ children, updateFilters }) => {
    ...
    const [selectedDepartmentFilter, setSelectedDepartmentFilter] = useState("Me");

    function radioButtonChangeHandler(value) {
        setSelectedDepartmentFilter(value);
        updateFilters(value, "showMyorAllDepartment");
    }

    function OpenOrClosedTaskChangeHandler(value) {
        setSelectedTaskFilter(value);
        updateFilters(value, "openOrClosedTaskFilter");
    }
